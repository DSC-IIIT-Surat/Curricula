...
public class CO3Activity extends AppCompatActivity {
    ...
    public void initData() {
        ...
        examPapers.add(new DataURL("MidSem 19","https://drive.google.com/open?id=1U4ScqRfXQL0VnMsbvJ9tv8bP9lM8Zjj2"));
        examPapers.add(new DataURL("EndSem 19","https://drive.google.com/open?id=1t3DrjOLJPtY-JC7jT2BgVxYr8KF8vu9K"));
