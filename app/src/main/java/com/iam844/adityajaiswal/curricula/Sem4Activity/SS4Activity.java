...
public class SS4Activity extends AppCompatActivity {
    ...
    public void initData() {
        ...
        examPapers.add(new DataURL("MidSem 20","https://drive.google.com/open?id=18kzagPABaN4qG2-_M_uIUau0ke_XSm_F"));

//        examPapers.add(new DataURL("EndSem 19"));
        List<DataURL> newMaterial=new ArrayList<>();
        newMaterial.add(new DataURL("Macro","https://drive.google.com/open?id=1GVQQ28fLxo510c39bTtTALhXJVbZZ9Wp"));
