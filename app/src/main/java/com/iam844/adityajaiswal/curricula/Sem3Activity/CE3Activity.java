...
//        classMaterials.add(new DataURL("",""));
        ...
        examPapers.add(new DataURL("MidSem 19","https://drive.google.com/open?id=1x_l62J0T-1O0YdI0ZDZ5cPlEDHLpUkXO"));
        examPapers.add(new DataURL("EndSem 19","https://drive.google.com/open?id=1aRLQHHYbaqI_gEgKXWWHORmfgCdGrKDD"));
