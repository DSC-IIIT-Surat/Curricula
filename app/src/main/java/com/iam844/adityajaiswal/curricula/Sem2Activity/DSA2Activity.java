...
//        books.add(new DataURL("",""));
        ...
        newMaterial.add(new DataURL("Sorting and Searching","https://drive.google.com/open?id=1D5tWfE0T_JZzn2K3eqwsg67KhpiBpYXP"));
        newMaterial.add(new DataURL("Hashing","https://drive.google.com/open?id=1M92RdzbqyjGs7OcKNzBbSvTzjG9OrMz1"));
