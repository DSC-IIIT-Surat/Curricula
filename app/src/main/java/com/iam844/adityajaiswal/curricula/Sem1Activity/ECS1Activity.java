...
public class ECS1Activity extends AppCompatActivity {
        ...
        listView.setOnChildClickListener(new ExpandableListView.OnChildClickListener() {
            ...
            public boolean onChildClick(ExpandableListView expandableListView, View view, int i, int i1, long l) {
                ...
                if(listHash.get(listDataHeader.get(i)).get(i1).getmURL() == null ){
                    ...
                    Log.e("COMPLETE NAME", listHash.get(listDataHeader.get(i)).get(i1).getmName());
    ...
    public void initData() {
        ...
        classMaterials.add(new DataURL("Job Interview FAQs", "https://drive.google.com/open?id=12vsCM7v3fTyYHMGRZGFvWV-rA2GGrz1z"));
        ...
        classMaterials.add(new DataURL("Non Verbal Communication", "https://drive.google.com/open?id=1Dk1HmtR2SOilUzD6IkGyUheOp2B0ziiv"));
