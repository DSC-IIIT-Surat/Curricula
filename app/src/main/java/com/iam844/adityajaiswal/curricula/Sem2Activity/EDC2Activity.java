...
public class EDC2Activity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_edc2);

        //Toolbar
        Toolbar toolbar = findViewById(R.id.toolbar_activity_edc2);
        ...
        listView = findViewById(R.id.edc2_listView);
        initData();
    ...
    public void initData() {
        ...
        newMaterial.add(new DataURL("BJT Structure & Operation","https://drive.google.com/open?id=1z1sbFtLPkWHpMdZgk6RdriYm5BawawWZ"));
        newMaterial.add(new DataURL("BJT Characteristics and other topics","https://drive.google.com/open?id=1yoGC7rX-DuX1yfOCLm29Hq9TzKRc4sYe"));
        newMaterial.add(new DataURL("BJT circuits at DC Notes","https://drive.google.com/open?id=1QRnBdijkf1ZwQqMr29ORvJu7xs2iLWgR"));
        newMaterial.add(new DataURL("Transistor Amplifier","https://drive.google.com/open?id=1cGAugiZ8wVRIMShjG1b5AWbozjTSPbG5"));
        newMaterial.add(new DataURL("EC 202 Electronic Devices and Circuits NPTEL video","https://drive.google.com/open?id=1MVjJdT82Fk53REBISWcn7H5ZH3WEAqpz"));
